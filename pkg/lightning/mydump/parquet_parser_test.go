...
func TestParquetParser(t *testing.T) {
	...
	reader := newParquetParserForTest(t, dir, name, ParquetFileMeta{})
...
func TestParquetParserMultipleRowGroup(t *testing.T) {
	...
	parser := newParquetParserForTest(t, dir, fileName, ParquetFileMeta{})
...
func TestParquetVariousTypes(t *testing.T) {
	t.Run("timestamp_and_decimal", func(t *testing.T) {
		...
		reader := newParquetParserForTest(t, dir, name, ParquetFileMeta{Loc: time.UTC})
	...
	t.Run("decimal_with_nulls", func(t *testing.T) {
		...
		reader := newParquetParserForTest(t, dir, fileName, ParquetFileMeta{})
...
func TestParquetAurora(t *testing.T) {
	...
	parser := newParquetParserForTest(t, "examples", fileName, ParquetFileMeta{})
